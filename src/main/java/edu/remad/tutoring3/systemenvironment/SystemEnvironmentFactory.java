...
public final class SystemEnvironmentFactory {
	...
	private static final String[] CONFIG_PROPERTIES = {
			"TUTOR_ADMIN",
			"TUTOR_ADMIN_PASSWORD",
			"TUTOR_USER",
			"TUTOR_STAGE",
			"TUTOR_USER_PASSWORD",
			"SMTP_PASSWORD",
			"SMTP_USER",
			"TUTORING3_DATA_SOURCES_MYSQL_URL",
			"TUTORING3_DATA_SOURCES_MYSQL_USERNAME",
			"TUTORING3_DATA_SOURCES_MYSQL_PASSWORD",
			"TUTORING3_DEVELOPMENT_DATA_SOURCES_MYSQL_URL",
			"TUTORING3_DEVELOPMENT_DATA_SOURCES_MYSQL_USERNAME",
			"TUTORING3_DEVELOPMENT_DATA_SOURCES_MYSQL_PASSWORD",
			"TUTORING3_DEVELOPMENT_KEYCLOAK_KEY_SET_URI"
	};
	...
	private static SystemEnvironment createSystemEnvironment() {
		...
		return createAndPopulateProperties(systemVaries);
	}
	...
	private static SystemEnvironment createAndPopulateProperties(Map<String, String> systemVaries) {
		...
		if (systemVaries != null && !systemVaries.isEmpty()) {
			...
			for(String configProperty : CONFIG_PROPERTIES) {
